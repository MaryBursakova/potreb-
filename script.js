(() => {
  ...
  if(b&&n){
    ...
    n.querySelectorAll('a').forEach(a=>a.addEventListener('click',()=>n.classList.remove('is-open')));
  }
  ...
  if(f){
    f.addEventListener('submit',e=>{
      ...
      if(s)s.textContent='Открываем письмо с заполненной заявкой';
